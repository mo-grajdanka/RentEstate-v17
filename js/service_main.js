document.addEventListener('DOMContentLoaded', function () {
	...
	// ================== super-groups (Шаг 0) ==================
const SUPER_GROUPS = {
  'Здоровье и красота': ['Ветеринария', 'Медицина', 'Бьюти сфера'],
  'Спорт и досуг': ['Спорт', 'Досуговое пространство'],
  'Ритейл и общепит': ['Торговля', 'Общепит'],
  'Авто': ['Автосервис'],
  'Образование': ['Детское образование'],
};
